 ...
 * @method sendPeers
 */
internals.Peer.prototype.sendPeers = function(peers) {
 ...
 */
internals.Peer.prototype.sendTransactions = function(transactions) {
 ...
 * @method sendBlocks
 */
internals.Peer.prototype.sendBlocks = function(blocks) {
 ...
 * @method sendGetChain
 */
internals.Peer.prototype.sendGetChain = function(parents) {
    this.sendMessage([0x14, 0x10]);
};
...
internals.Peer.prototype._onData = function(data) {
    ...
    switch (payload[0][0]) {
        ...
        case 0x01:
            //disconnect
            this.network.emit("message.disconnect", this, {
                reason: DISCONNECT_REASON[payload[1]]
            }, payload, data);
            this.emit("message.disconnect", {
                reason: DISCONNECT_REASON[payload[1]]
            }, payload, data);
            this.sock.end();
            break;
